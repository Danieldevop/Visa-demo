...
class ApiClient(object):
    ...
    def __init__(self, host=None, header_name=None, header_value=None, cookie=None):
        ...
        self.user_agent = 'VDP_SampleCode_Python'
    ...
    def __call_api(self, path, resource_path, method,
        ...
        # auth setting
        self.update_params_for_auth(header_params, query_params, auth_settings, resource_path, json.dumps(body))
    ...
    def call_api(self, path, resource_path, method,
                 path_params=None, query_params=None, header_params=None,
                 body=None, post_params=None, files=None,
                 response_type=None, auth_settings=None, callback=None,
                 _return_http_data_only=None, collection_formats=None, _preload_content=True,
        ...
        :param resource_path: Resource path for the endpoint.
        ...
        """
        if callback is None:
            return self.__call_api(path, resource_path, method,
            ...
            thread = threading.Thread(target=self.__call_api,
                                      args=(path, resource_path, method,
    ...
    def update_params_for_auth(self, headers, query_params, auth_settings, resource_path, body):
        """
        ...
        :param resource_path Resource Path for the endpoint (Needed for XPayToken APIs)
        """
        ...
        for auth in auth_settings:
            auth_setting = config.auth_settings(auth, query_params, resource_path, body)
            if auth_setting:
